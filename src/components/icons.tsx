...
export const Icons = {
  ...
  Discord: function Discord({
    ...
    return (
        <svg {...props} viewBox="0 0 256 199" className={className} width={width} height={height} preserveAspectRatio="xMidYMid">
          <path
  ...
  Gmail: function Gmail({
    ...
    return (
        <svg width={width} height={height} className={className} viewBox="0 49.4 512 399.42">
  ...
  Zoom: function Zoom({
    ...
    return (
        <svg width={width} height={height} className={className} preserveAspectRatio="xMidYMid" viewBox="0 0 256 256">
          <defs>
            <linearGradient
              id="zoom__a"
              x1="23.666%"
  ...
  Bitbucket: (props: React.ComponentProps<"svg">) => (
    <svg
      {...props}
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      <path
        d="M0.778 1.213a.768.768 0 0 0-.768.892l3.263 19.81c.084.499.515.867 1.022.867H19.95a.772.772 0 0 0 .77-.646l3.27-20.03a.768.768 0 0 0-.768-.893H.778zM14.52 15.53H9.522L8.17 8.466h7.704l-1.354 7.064z"
        fill="#2684FF"
      />
    </svg>
  ),
